...
public class WeatherHereCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		Color colorTemp = EnvironmentUtil.getColorFromTemperature(fahrenheit);
		...
		String direction = EnvironmentUtil.degreesToCardinal(weatherData.windDirection);
		...
		if (args.length > 0) {
			...
			Color colorTemp2 = EnvironmentUtil.getColorFromTemperature(temp);
